...
class NormalOperation(unittest.TestCase):
    ...
    * test data integrity is o.k.
    ...
    def test_aeon2(self):
        ...
        self.assertEqual(extract_json.run(TEST_AEON2), 'SUCCESS: "' + os.path.normpath(TEST_JSON2) + '" written.')
        self.assertEqual(read_file(TEST_JSON2), read_file(REF_JSON2))

    def test_aeon3(self):
        copyfile(AEON3, TEST_AEON3)
        self.assertEqual(extract_json.run(TEST_AEON3), 'SUCCESS: "' + os.path.normpath(TEST_JSON3) + '" written.')
